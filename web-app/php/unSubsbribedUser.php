...
<body>
    ...
    <section class="section-f animation" id="">
        <div class="row">
            <h2>Get fresh milk  &mdash; Not milk powder</h2>
            <p class="para1">
                ...
                <div class="plan-box package">
                   <div>
                        ...
                        <p class="plan-price-meal">
                            <h4 style="font-family: 'Gowun Dodum', sans-serif;">That’s only RS.<?php plan(20); ?> per liter</h4>
                        </p>
                    </div>
                    <div>
                        <ul style="font-family: sans-serif;">
                            ...
                            <li><i class="ion-ios-checkmark-empty icon-small"> </i>Morning or evening</li>
                        </ul>
                    </div>
                    <div class="overview">
                        <h3>subscribe</h3>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box package">
                     <div>
                        ...
                        <p class="plan-price-meal">
                            <h4 style="font-family: 'Gowun Dodum', sans-serif;">That’s only RS.<?php plan(10); ?> per liter</h4>
                        </p>
                    </div>
                    <div>
                        <ul style="font-family: sans-serif;">
            ...
            <div class="col span-1-of-3">
                <div class="plan-box package">
                    <div>
                        ...
                        <p class="plan-price-meal">
                            <h4 style="font-family: 'Gowun Dodum', sans-serif;">That’s only RS.<?php plan(5); ?> per liter</h4>
                        </p>
                    </div>
                    <div>
                        <ul style="font-family: sans-serif;">
                            ...
                            <li><i class="ion-ios-checkmark-empty icon-small"> </i>minimum 1 Liters</li>
                            <li><i class="ion-ios-checkmark-empty icon-small"> </i>Free delivery</li>
                            <li><i class="ion-ios-checkmark-empty icon-small"> </i>Morning only</li>
                                    ...
                                    <div class="row">
                                        <form action="#" method="post" class="contact-form" onsubmit="validateFormOarder()" name="myForm" >
                                            <div class="row">
                                                ...
                                                <div class="col span-2-of-3" style="font-family: 'Gowun Dodum', sans-serif;">
